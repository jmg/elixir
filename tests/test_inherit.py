...
class TestInheritance(object):
    ...
    def test_singletable_inheritance(self):
        ...
        lisa = PersonExtended(firstname="Lisa", surname="Simpson", parent=homer)
        bart = PersonExtended(firstname="Bart", surname="Simpson", parent=homer,
                              sister=lisa)
        ...
        # This doesn't work since the sister relation points to a Person object,
        # not a PersonExtended one.
